...
if((eixo == 0 && vrv != 3) || (eixo == 1 && vrv > 11) || eixo == 2){
        ...
        function analyze(error, data) {
            ...
            if(eixo == 1 && vrv >= 12 && url['ocp'] == 1){
                ...
                if (eixo == 0 || eixo == 1) {
                        ...
                        if (eixo == 0) {
                            ...
                            if (url['var'] > 11) {
                                if (url['ocp'] == 0) {
                                    ...
                                    if (colorId == "Relacionadas") {
                                        colorReturn = "#071342";
                                    } else if (colorId == "Culturais") {
                                        colorReturn = "rgb(109, 191, 201)";
                                    }
                                }
                   ...
                   //x.domain([2007, 2008, 2009, 2011, 2012, 2013 ,2014]);
                ...
                if (eixo >= 0) {
                    ...
                    x.domain(d3.extent(dados, function (d) {
                        return d.ano;
                    }));
                    //x.domain([2007, 2008, 2009, 2011, 2012, 2013 ,2014]);
                    y.domain([0, maxDateVal]);
